...
namespace mdryden.cflapi.v1.ClientTests.Games
{
	...
	public class GameFilterNotEqualsTests : ClientTestsBase
	{
		...
		[Ignore] // filtering by date does not appear to work
		[TestMethod]
		public void FilterByDateStartTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.DateStart(FilterOperators.NotEqualTo, filterValue) } };
		...
		public void FilterBySeasonTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Season(FilterOperators.NotEqualTo, filterValue) } };
		...
		public void FilterByWeekTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Week(FilterOperators.NotEqualTo, filterValue) } };
		...
		public void FilterByTemperatureTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Temperature(FilterOperators.NotEqualTo, filterValue) } };
		...
		public void FilterByAttendanceTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Attendance(FilterOperators.NotEqualTo, filterValue) } };
		...
		public void FilterByTeam1Test()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Team1(FilterOperators.NotEqualTo, filterValue) } };
		...
		public void FilterByTeam2Test()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Team2(FilterOperators.NotEqualTo, filterValue) } };
