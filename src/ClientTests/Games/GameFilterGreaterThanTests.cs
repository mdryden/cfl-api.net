...
namespace mdryden.cflapi.v1.ClientTests.Games
{
	...
	public class GameFilterGreaterThanTests : ClientTestsBase
	{
		...
		public void FilterByDateStartTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.DateStart(FilterOperators.GreaterThan, filterValue) } };
		...
		public void FilterBySeasonTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Season(FilterOperators.GreaterThan, filterValue) } };
		...
		public void FilterByTemperatureTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Temperature(FilterOperators.GreaterThan, filterValue) } };
		...
		public void FilterByAttendanceTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Attendance(FilterOperators.GreaterThan, filterValue) } };
		...
		public void FilterByTeam1Test()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Team1(FilterOperators.GreaterThan, filterValue) } };
		...
		public void FilterByTeam2Test()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Team2(FilterOperators.GreaterThan, filterValue) } };
