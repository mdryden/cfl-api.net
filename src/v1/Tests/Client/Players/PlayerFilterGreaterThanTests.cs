...
namespace mdryden.cflapi.v1.Tests.Client.Players
{
	...
	public class PlayerFilterGreaterThanTests : ClientTestsBase
	{
		...
		public void CflCentralIdTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.CflCentralId.GreaterThan(filterValue) } };
		...
		public void FirstNameTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.FirstName.GreaterThan(filterValue) } };
		...
		public void MiddleNameTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.MiddleName.GreaterThan(filterValue) } };
		...
		public void LastNameTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.LastName.GreaterThan(filterValue) } };
		...
		public void BirthDateTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.BirthDate.GreaterThan(filterValue) } };
  ...
  //          var actual = players.First().Height > decimal.Parse($"{feet}.{inches.ToString("00")}");
		...
		public void WeightTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.Weight.GreaterThan(filterValue) } };
		...
		public void RookieYearTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.RookieYear.GreaterThan(filterValue) } };
		...
		public void ForeignPlayerTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.ForeignPlayer.GreaterThan(filterValue) } };
		...
		public void SchoolIdTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.SchoolId.GreaterThan(filterValue) } };
		...
		public void SchoolNameTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.SchoolName.GreaterThan(filterValue) } };
		...
		public void PositionIdTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.PositionId.GreaterThan(filterValue) } };
		...
		public void PositionAbbreviationTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.PositionAbbreviation.GreaterThan(filterValue) } };
		...
		public void OffenceDefenceOrSpecialTest()
		{
			...
			//var options = new PlayersRequestOptions { Filters = new[] { PlayerFilter.OffenceDefenceOrSpecial.GreaterThan(filterValue) } };
