...
namespace mdryden.cflapi.v1.Tests.Client.Players
{
	...
	public class PlayerFilterLessThanOrEqualToOrEqualToTests : ClientTestsBase
	{
		...
		public void CflCentralIdTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.CflCentralId.LessThanOrEqualTo(filterValue) } };
		...
		public void FirstNameTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.FirstName.LessThanOrEqualTo(filterValue) } };
		...
		public void MiddleNameTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.MiddleName.LessThanOrEqualTo(filterValue) } };
		...
		public void LastNameTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.LastName.LessThanOrEqualTo(filterValue) } };
		...
		public void BirthDateTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.BirthDate.LessThanOrEqualTo(filterValue) } };
  ...
  //          var actual = players.First().Height <= decimal.Parse($"{feet}.{inches.ToString("00")}");
		...
		public void WeightTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.Weight.LessThanOrEqualTo(filterValue) } };
		...
		public void RookieYearTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.RookieYear.LessThanOrEqualTo(filterValue) } };
		...
		public void ForeignPlayerTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.ForeignPlayer.LessThanOrEqualTo(filterValue) } };
		...
		public void SchoolIdTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.SchoolId.LessThanOrEqualTo(filterValue) } };
		...
		public void SchoolNameTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.SchoolName.LessThanOrEqualTo(filterValue) } };
		...
		public void PositionIdTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.PositionId.LessThanOrEqualTo(filterValue) } };
		...
		public void PositionAbbreviationTest()
		{
			...
			var options = new PlayersRequestOptions { Filters = new[] { PlayersFilterFactory.PositionAbbreviation.LessThanOrEqualTo(filterValue) } };
		...
		public void OffenceDefenceOrSpecialTest()
		{
			...
			//var options = new PlayersRequestOptions { Filters = new[] { PlayerFilter.OffenceDefenceOrSpecial.LessThanOrEqualTo(filterValue) } };
