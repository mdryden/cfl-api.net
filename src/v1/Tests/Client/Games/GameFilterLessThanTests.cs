...
namespace mdryden.cflapi.v1.Tests.Client.Games
{
	...
	public class GameFilterLessThanTests : ClientTestsBase
	{
		...
		public void FilterByDateStartTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { FluentGamesFilterFactory.DateStart.LessThan(filterValue) } };
		...
		public void FilterBySeasonTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { FluentGamesFilterFactory.Season.LessThan(filterValue) } };
		...
		public void FilterByWeekTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { FluentGamesFilterFactory.Week.LessThan(filterValue) } };
		...
		public void FilterByTemperatureTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { FluentGamesFilterFactory.Temperature.LessThan(filterValue) } };
		...
		public void FilterByAttendanceTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { FluentGamesFilterFactory.Attendance.LessThan(filterValue) } };
		...
		public void FilterByTeam1Test()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { FluentGamesFilterFactory.Team1.LessThan(filterValue) } };
		...
		public void FilterByTeam2Test()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { FluentGamesFilterFactory.Team2.LessThan(filterValue) } };
		...
		public void FilterByEventTypeTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { FluentGamesFilterFactory.EventTypeId.LessThan(EventTypeIds.RegularSeason) } };
		...
		public void FilterPlayByPlayTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { FluentGamesFilterFactory.PlayByPlaySequence.LessThan(filterValue) } };
