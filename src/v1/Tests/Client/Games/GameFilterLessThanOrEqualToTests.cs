...
namespace mdryden.cflapi.v1.Tests.Client.Games
{
	...
	public class GameFilterLessThanOrEqualToTests : ClientTestsBase
	{
		...
		public void FilterByDateStartTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GamesFilterFactory.DateStart.LessThanOrEqualTo(filterValue) } };
		...
		public void FilterBySeasonTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GamesFilterFactory.Season.LessThanOrEqualTo(filterValue) } };
		...
		public void FilterByWeekTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GamesFilterFactory.Week.LessThanOrEqualTo(filterValue) } };
		...
		public void FilterByTemperatureTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GamesFilterFactory.Temperature.LessThanOrEqualTo(filterValue) } };
		...
		public void FilterByAttendanceTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GamesFilterFactory.Attendance.LessThanOrEqualTo(filterValue) } };
		...
		public void FilterByTeam1Test()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GamesFilterFactory.Team1.LessThanOrEqualTo(filterValue) } };
		...
		public void FilterByTeam2Test()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GamesFilterFactory.Team2.LessThanOrEqualTo(filterValue) } };
