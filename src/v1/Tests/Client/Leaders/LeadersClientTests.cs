...
namespace mdryden.cflapi.v1.Tests.Client.Leaders
{
	...
	public class LeadersClientTests : ClientTestsBase
	{
		...
		public void Get2015ReceivingTouchdownsTeamFilterTest()
		{
			...
			var leaders = client.GetReceivingTouchdowns(2015, options: new LeadersRequestOptions { Filters = new[] { LeadersFilterFactory.TeamId.EqualTo(1) } });
		...
		public void Get2015ReceivingTouchdownsEndDateFilterTest()
		{
			...
			var leaders = client.GetReceivingTouchdowns(2015, options: new LeadersRequestOptions { Filters = new[] { LeadersFilterFactory.EndDate.LessThan(new DateTime(2015, 08, 01)) } });
