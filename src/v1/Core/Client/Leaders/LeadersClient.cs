...
namespace mdryden.cflapi.v1.Client.Leaders
{
	public class LeadersClient : ClientBase
	{
		...
		public IList<PlayerInterceptions> GetInterceptions(int season, int? topX = null, LeadersRequestOptions options = null, bool includeExtendedData = false)
		{
			return GetLeadersList<PlayerInterceptions>(season, topX, "interceptions", options, includeExtendedData);
		}
		...
		public IList<PlayerReceivingTouchdowns> GetReceivingTouchdowns(int season, int? topX = null, LeadersRequestOptions options = null)
		{
			return GetLeadersList<PlayerReceivingTouchdowns>(season, topX, "receiving_touchdowns", options);
		}
