...
namespace mdryden.cflapi.v1.Tests.Client.TeamLeaders
{
	...
	public class TeamLeadersClientTests : ClientTestsBase
	{
		...
		public void Get2015AllCategoriesTeamFilterTest()
		{
			...
			var leaders = client.GetAllCategories(2015, options: new TeamLeadersRequestOptions { Filters = new[] { new TeamLeadersFilter(TeamLeadersFilterTypes.TeamId, FilterOperators.EqualTo, "1") } });
		...
		public void Get2015PassingYardsEndDateFilterTest()
		{
			...
			var leaders = client.GetPassingYards(2015, options: new TeamLeadersRequestOptions { Filters = new[] { new TeamLeadersFilter(TeamLeadersFilterTypes.EndDate, FilterOperators.LessThan, "2015-08-01") } });
		...
		public void Get2015TotalYardsForWeekTest()
		{
			...
			var leaders = client.GetTotalYards(2015, options: new TeamLeadersRequestOptions { Filters = new[] { new TeamLeadersFilter(TeamLeadersFilterTypes.Week, FilterOperators.EqualTo, "2") } });
