...
namespace mdryden.cflapi.v1.Tests.Client.Games
{
	...
	public class GameFilterLessThanTests : ClientTestsBase
	{
		...
		public void FilterByDateStartTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.DateStart(FilterOperators.LessThan, filterValue) } };
		...
		public void FilterBySeasonTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Season(FilterOperators.LessThan, filterValue) } };
		...
		public void FilterByWeekTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Week(FilterOperators.LessThan, filterValue) } };
		...
		public void FilterByTemperatureTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Temperature(FilterOperators.LessThan, filterValue) } };
		...
		public void FilterByAttendanceTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Attendance(FilterOperators.LessThan, filterValue) } };
		...
		public void FilterByTeam1Test()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Team1(FilterOperators.LessThan, filterValue) } };
		...
		public void FilterByTeam2Test()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Team2(FilterOperators.LessThan, filterValue) } };
