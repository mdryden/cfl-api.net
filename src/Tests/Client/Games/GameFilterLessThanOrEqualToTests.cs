...
namespace mdryden.cflapi.v1.Tests.Client.Games
{
	...
	public class GameFilterLessThanOrEqualToTests : ClientTestsBase
	{
		...
		public void FilterByDateStartTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.DateStart(FilterOperators.LessThanOrEqualTo, filterValue) } };
		...
		public void FilterBySeasonTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Season(FilterOperators.LessThanOrEqualTo, filterValue) } };
		...
		public void FilterByWeekTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Week(FilterOperators.LessThanOrEqualTo, filterValue) } };
		...
		public void FilterByTemperatureTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Temperature(FilterOperators.LessThanOrEqualTo, filterValue) } };
		...
		public void FilterByAttendanceTest()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Attendance(FilterOperators.LessThanOrEqualTo, filterValue) } };
		...
		public void FilterByTeam1Test()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Team1(FilterOperators.LessThanOrEqualTo, filterValue) } };
		...
		public void FilterByTeam2Test()
		{
			...
			var options = new GamesRequestOptions { Filters = new[] { GameFilter.Team2(FilterOperators.LessThanOrEqualTo, filterValue) } };
